...
class IntentProvider(IntentProviderBase):
    ...
    def get_intent_system_prompt(self, functions_list: str) -> str:
        ...
        prompt = (
            ...
            "- 当用户说'记住我，我是XXX'、'我是XXX'、'注册人脸'、'记住我的脸'等表达要记住身份或注册人脸的意图时，必须触发 face_register\n\n"
            f"{functions_desc}\n"
            "处理步骤:\n"
            "1. 分析用户输入，确定用户意图\n"
            "2. 从可用函数列表中选择最匹配的函数\n"
            ...
            "```\n"
            "用户: 记住我，我是张三\n"
            '返回: {"function_call": {"name": "face_register", "arguments": {"identity_id": "test1", "name": "张三"}}}\n'
            "```\n"
            "```\n"
            "用户: 注册，我是李四\n"
            '返回: {"function_call": {"name": "face_register", "arguments": {"identity_id": "test2", "name": "李四"}}}\n'
            "```\n"
            "```\n"
            "用户: 我想结束对话\n"
